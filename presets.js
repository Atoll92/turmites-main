const presetDefinitions = {
    ...
    musicalArpeggio: {
        ...
        rules: {
            0: [
                { writeColor: 1, move: '>', nextState: 1 }, // Move right, build ascending scale
                { writeColor: 2, move: '^', nextState: 0 }  // Move up, create rhythm
            ],
            1: [
                { writeColor: 3, move: '>', nextState: 2 }, // Continue right
                { writeColor: 4, move: '^', nextState: 1 }  // Move up
            ],
            2: [
                { writeColor: 5, move: '<', nextState: 3 }, // Turn around, descending
                { writeColor: 6, move: '^', nextState: 2 }  // Up for rhythm
            ],
            3: [
                { writeColor: 0, move: '<', nextState: 0 }, // Reset cycle
                { writeColor: 1, move: 'v', nextState: 3 }  // Down for bass notes
            ]
        }
    },
    rhythmicBeats: {
        ...
        rules: {
            0: [
                { writeColor: 1, move: 'v', nextState: 1 }, // Strong downbeat
                { writeColor: 2, move: 'R', nextState: 0 }  // Turn for pattern
            ],
            1: [
                { writeColor: 3, move: 'v', nextState: 2 }, // Mid beat
                { writeColor: 4, move: 'L', nextState: 1 }  // Turn
            ],
            2: [
                { writeColor: 5, move: '^', nextState: 0 }, // Upbeat
                { writeColor: 0, move: 'U', nextState: 2 }  // Reset
            ]
        }
    },
    harmonicDrone: {
        ...
        rules: {
            0: [
                { writeColor: 1, move: 'S', nextState: 1 }, // Stay and sustain
                { writeColor: 2, move: 'R', nextState: 0 }  // Slight variation
            ],
            1: [
                { writeColor: 3, move: 'S', nextState: 2 }, // Continue sustain
                { writeColor: 4, move: 'L', nextState: 1 }  // Variation
            ],
            2: [
                { writeColor: 5, move: 'S', nextState: 0 }, // Sustain cycle
                { writeColor: 1, move: 'U', nextState: 2 }  // Pitch shift
            ]
        }
    }
}; 